...
- **FastAPI backend** (`app/main.py`) with placeholder telemetry endpoints.
...
- Replace placeholder values in `app/main.py` with sensor polling, alerting, and RTSP snapshot logic.
